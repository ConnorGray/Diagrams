    ...
    let diagram = Diagram {
        ...
        arrows: vec![
            Arrow {
                ...
                text: Text::new(""),
                start_at: Some(Attachment::Border(Side::Right, Some(0.8))),
                end_at: Some(Attachment::Border(Side::Left, Some(0.8))),
            },
            Arrow {
                start: lib_a.clone(),
                end: lib_b.clone(),
                text: Text::new(""),
                start_at: Some(Attachment::Border(Side::Right, Some(0.2))),
